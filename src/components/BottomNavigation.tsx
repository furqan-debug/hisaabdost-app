    ...
    <>
      <div className="fixed left-0 right-0 bottom-0 z-50 w-full overflow-visible" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
        <div className={cn(
          ...
          <div className="absolute left-1/2 -translate-x-1/2 top-0 -translate-y-3 z-10">
            <motion.div whileTap={{ scale: 0.9 }}>
              <Button
                onClick={handleFabClick}
                size="icon"
                className="h-16 w-16 rounded-full bg-white dark:bg-white shadow-2xl shadow-primary/50 hover:shadow-primary/70 active:ring-4 active:ring-primary/40 transition-all duration-200 border-4 border-primary/30 dark:border-primary/50 p-2"
              >
                <img src="/lovable-uploads/12aae181-1a03-4067-a879-2f29d4213837.png" alt="Finny AI" className="w-full h-full object-contain" />
              </Button>
            </motion.div>
          </div>
