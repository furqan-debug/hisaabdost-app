    ...
    <div className="relative min-h-screen flex items-center justify-center bg-background px-6">
      ...
      >
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-foreground">Hisaab Dost</h1>
        ...
        >
          Track expenses, build wealth, and achieve your goals with confidence. Your journey to financial freedom starts
          here.
        </motion.p>
